...
L.COMMISSION_INVALID = "enter 0 for unspecified, -1 for any commission, or a gold value up to 99,999,999."
...
L.WHO_USAGE = "/af who <character> - test an exact /who lookup"
L.WHO_CHECK_STARTED = "who check started for %s."
L.WHO_CHECK_NOT_STARTED = "who check did not start for %s."
