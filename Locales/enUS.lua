...
L.OPTIONAL_REAGENTS_TOOLTIP = "With common optional reagents: +%d difficulty, %s."
L.OPTIONAL_REAGENTS_TOOLTIP_CONCENTRATION = "With common optional reagents: +%d difficulty, %s or %s with concentration."
L.OPTIONAL_REAGENTS_TOOLTIP_DIFFICULTY = "Common optional reagents add %d difficulty."
