...
[] If less than X results show for a craft, show cached crafters as "Offline (last seen ...)"

[x] Check if changing items rescans all recipes. -> It doesn't. Should it ?
[] Check if it's possible to rescan only items who's skill changed